...
import styles from './moretolove.module.css';
    ...
    const displayProdfuctsBags = async () => {
        ...
        try {
            const product = await client.getEntries(
                {
                    'content_type': 'moretolovebrandlist',
                }
            )
            
            const filteredProducts = product.items.filter((item) => item.fields.brand === id);
        ...
        <>
            ...
            <div className={styles.Layout2}>
                <div className='flex gap-4 items-center'>
                    ...
                    <h1 className={styles.Layout2text}>{id}</h1>
                                ...
                                return (
                                    <>
                                        ...
                                        <div class={`${styles.layout2con} lg:w-1/4 sm:w-1/2 md:w-1/2 xs:w-1/2`}>
                                            <Link href={`/view/moretoloveDetails?id=${item?.sys?.id}`}>
                                                <div class=" px-0 pt-10 pb-0 rounded-lg overflow-hidden relative h-full">
                                                    <img src={item?.fields?.subimage1?.fields?.file?.url} className={styles.imageLayout2} />
